...
import { myservicesClient } from './services/myservices/myservices.shared'
export type {
  Myservices,
  MyservicesData,
  MyservicesQuery,
  MyservicesPatch
} from './services/myservices/myservices.shared'
...
/**
 * Returns a typed client for the Project Task app.
 *
...
export const createClient = <Configuration = any,>(
  ...
  client.configure(myservicesClient)
