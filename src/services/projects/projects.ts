...
import { ProjectsService, getProjectsService, getTasksService } from './projects.class'
...
export const projects = (app: Application) => {
  ...
  app.use(projectsPath, new ProjectsService(getProjectsService(app), getTasksService(app)), {
